...
function Address() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/finduser")
      .then((response) => {
              ...
              <a href="/account">
                <div className="nav-menu-item">
                  <div className="flex centerY">
                    <img
                      className="icon-nav-index"
                      src="https://cdn.discordapp.com/attachments/787359617280770051/1185561360084516884/17.png?ex=65900f0e&is=657d9a0e&hm=2f00dae461fd86c9ca1e2b28e2afa51ec1f628cc08c73f50c84289f8ce2142f2&"
                      alt="showcase"
                    />
                  </div>
              ...
              <a href="/address">
                ...
                >
                  <div className="flex centerY">
                    <img
                      className="icon-nav-index"
                      src="https://cdn.discordapp.com/attachments/787359617280770051/1186487348813373470/11.png?ex=65936d73&is=6580f873&hm=ae836c844c07618dac37804c6f271983ecf62a8255417bf8b59270af84a9c4fd&"
                      alt="showcase"
                    />
                  </div>
